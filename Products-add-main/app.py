...
# Image generation service selection - GEMINI (Nano Banana)
IMAGE_MODEL = 'gemini'  # Use Gemini Nano Banana for image generation
logger.info("🎨 Using Gemini Nano Banana (Google) for image generation")
gemini_api_keys = os.getenv('GOOGLE_API_KEY', '').strip()
gemini_service = GeminiService(gemini_api_keys)
